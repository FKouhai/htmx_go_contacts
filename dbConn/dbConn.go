...
`
var connString = "user=" + config.GetConfig().Username + " dbname=" + config.GetConfig().Db + " sslmode=disable password=" + config.GetConfig().Password + " host=" + config.GetConfig().Host
